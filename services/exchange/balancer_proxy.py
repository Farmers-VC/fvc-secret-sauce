...
class BalancerProxyExchange(ExchangeInterface):
    ...
    def calc_amount_out(self, token_in: Token, token_out: Token, amount_in_wei: int) -> int:
        ...
        _, amount_out_wei = self.contract.functions.viewSplitExactIn(token_in.address, token_out.address, amount_in_wei, 5).call()
        ...
        # token_in_denormalized_weight = self.contract.functions.getDenormalizedWeight(token_in.address).call()
        # token_out_denormalized_weight = self.contract.functions.getDenormalizedWeight(token_out.address).call()
